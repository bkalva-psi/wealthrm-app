        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center md:hidden ml-2">
            ...
            <div className="ml-2 flex flex-col justify-center">
              <h1 className="text-teal-700 dark:text-teal-400 text-sm font-bold leading-tight whitespace-nowrap text-left">Ujjivan Small Finance Bank</h1>
              <span className="text-orange-600 dark:text-orange-400 text-xs font-medium leading-tight text-left">Intellect WealthForce</span>
            </div>
          </div>
