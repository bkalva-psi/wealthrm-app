              ...
              {tooltipInfo.visible && (
                ...
                >
                  ...
                  <div className="flex justify-between gap-3">
                    <span style={{ color: '#2563eb' }}>Portfolio: {tooltipInfo.portfolioValue.toFixed(1)}</span>
                    <span style={{ color: '#64748b' }}>Benchmark: {tooltipInfo.benchmarkValue.toFixed(1)}</span>
                  </div>
                </div>
              )}
            </div>
